...
class _GoogleAPI implements GoogleAPI {
  ...
  @override
  Future<SearchBooksGoogleResponse> getResultFromGoogle(keyword) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'q': keyword};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SearchBooksGoogleResponse>(
            Options(method: 'GET', headers: _headers, extra: _extra)
                .compose(_dio.options, 'books/v1/volumes',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = SearchBooksGoogleResponse.fromJson(_result.data!);
    return value;
  }
